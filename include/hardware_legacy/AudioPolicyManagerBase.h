...
protected:
        ...
        // true if given state represents a device in a telephone or VoIP call
        ...
        // manages A2DP output suspend/restore according to phone state and BY SC0 usage
        ...
        float mLastVoiceVolume;                                             // Ustawia ostatni status rozmowy w HALu
